    ...
    //创建原型
     Zolanav.prototype = {
        hd_fixed_top : function(){
            ...
            Tobj.wrapInner("<div class='hd-fixed-top'></div>");

            var hd_h = Tobj.height()
            var hd_offsettop = Tobj.offset().top;
            var scrollstart = this.options.scrollstart
